...
public class DotVelocitySecretAppConfig implements Serializable {
    ...
    public static Optional<DotVelocitySecretAppConfig> config() {
        return DotVelocitySecretAppConfigThreadLocal.INSTANCE.getConfig();
    }
    ...
    public static Optional<DotVelocitySecretAppConfig> config(final HttpServletRequest request) {
        ...
        if (DotVelocitySecretAppConfigThreadLocal.INSTANCE.getConfig().isPresent()) {
        ...
        DotVelocitySecretAppConfigThreadLocal.INSTANCE.setConfig(Optional.ofNullable(config));
